...
class SolutionController extends Controller
{
    public function index()
    {
        ...
        return view('backend.editor.solution.all_solution',compact('solutions'));
    }
...
//solution edit
        public function edit($id)
        {
            ...
            return view('backend.editor.solution.edit',compact('solution'));
        ...
        if ($image) {
            ...
            if ($success) {
                ...
                if ($user) {
                    ...
                    return Redirect()->route('editor.solution')->with($notification);
                }else{
                    return Redirect()->route('editor.solution');
                }
            }
        }else{
...
//solution view
    ...
    {
        $solution = Solution::where('id',$id)->first();
        return view('backend.editor.solution.view',compact('solution'));
    }
