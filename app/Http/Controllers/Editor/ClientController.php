...
class ClientController extends Controller
{
    public function index()
    {
        ...
        return view('backend.editor.client.all_client',compact('client'));
    }
...
//client edit
    ...
    public function edit($id)
    {
        ...
        return view('backend.editor.client.edit',compact('client'));
        ...
        if ($image) {
            ...
            if ($success) {
                ...
                if ($user) {
                    ...
                    return Redirect()->route('editor.client')->with($notification);
                }else{
                    return Redirect()->route('editor.client');
                }
            }
        }else{
...
//view
    ...
    {
        $client = Client::where('id',$id)->first();
        return view('backend.editor.client.view',compact('client'));
    }
