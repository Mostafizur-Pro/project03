...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($clients->client_publication == 1)
                                            <a href="{{route('editor.unpublished.client',$clients->id)}}" class="btn btn-sm btn-danger" >Published</a>
                                        @else
                                            <a href="{{route('editor.published.client',$clients->id)}}" class="btn btn-sm btn-info">Unpublished</a>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{route('editor.view.client',$clients->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                                        <a href="{{route('editor.edit.client',$clients->id)}}" class="btn btn-sm btn-info" ><i class="fa fa-edit"></i></a>
    ...
    @include('backend.editor.client.add_from')
