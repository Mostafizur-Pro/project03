...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($slider->s_p_status == 1)
                                            <a href="{{route('editor.unpublished.slider',$slider->id)}}" class="btn btn-sm btn-danger" >Published</a>
                                         @else
                                            <a href="{{route('editor.published.slider',$slider->id)}}" class="btn btn-sm btn-info" >Unpublished</a>
                                          @endif
                                    </td>
                                    <td>
                                        <a href="{{route('editor.view.slider',$slider->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                                        <a href="{{route('editor.edit.slider',$slider->id)}}" class="btn btn-sm btn-info" ><i class="fa fa-edit"></i></a>
    ...
    @include('backend.editor.slider.add_from')
