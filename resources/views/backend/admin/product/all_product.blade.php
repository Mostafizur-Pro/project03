...
@section('content')
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($products->p_p_status == 1)
                                            <a href="{{route('admin.unpublished.product',$products->id)}}" class="btn btn-sm btn-danger" >Published</a>
                                        @else
                                            <a href="{{route('admin.published.product',$products->id)}}"class="btn btn-sm btn-info" >Unpublished</a>
                                        @endif
                                    </td>
                                    <td>
                                        <a href="{{route('admin.view.product',$products->id)}}" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                                        <a href="{{route('admin.edit.product',$products->id)}}" class="btn btn-sm btn-info" ><i class="fa fa-edit"></i></a>
                                        <a href="{{route('admin.delete.product',$products->id)}}" class="btn btn-sm btn-danger" id="delete"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
    ...
    @include('backend.admin.product.add_from')
